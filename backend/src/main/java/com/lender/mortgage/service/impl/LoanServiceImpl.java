...
if (auth != null && auth.isAuthenticated()) {
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<LoanSummaryResponse> getLoansByAmountRange(BigDecimal minAmount, BigDecimal maxAmount,
            Pageable pageable) {
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<LoanSummaryResponse> getLoansByDateRange(LocalDateTime startDate, LocalDateTime endDate,
            Pageable pageable) {
    ...
    public void calculateLoanMetrics(Loan loan) {
        ...
        if (loan.getLoanAmount() != null && loan.getBorrowerAnnualIncome() != null &&
            ...
            if (loan.getInterestRate() != null && loan.getLoanTermMonths() != null) {
                ...
                BigDecimal payment = calculateMonthlyPayment(loan.getLoanAmount(), monthlyRate,
